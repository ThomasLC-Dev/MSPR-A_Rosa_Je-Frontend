        ...
        <div class="profil-info">
          <div class="form-field-direction">
            <div class="form-field field-2">
              ...
              <input type="text" id="roadNumber" :disabled="modificationAllowed == 1" v-model="user.address.roadNumber" />
            </div>
            <div class="form-field field-2">
              <label for="roadType">Type de voie :</label>
              <input type="text" id="roadType" :disabled="modificationAllowed == 1" v-model="user.address.roadType" />
            </div>
          ...
          <div class="form-field-direction">
            ...
            <div class="form-field field-1">
              ...
              <input type="text" id="postalCode" :disabled="modificationAllowed == 1" v-model="user.address.postalCode" />
            </div>
          ...
          <div class="group-checkbox">
            <div class="form-checkbox">
              <input type="checkbox" class="checkbox-position" id="customer" value="1" v-model="user.userRoles" />
              <label for="customer" class="register-checkbox">Avez-vous besoin de faire garder vos plantes ?</label>
            </div>

            <div class="form-checkbox">
              <input type="checkbox" class="checkbox-position" id="keeper" value="2" v-model="user.userRoles" />
              <label for="keeper" class="register-checkbox">Voulez-vous être gardien de plantes ?</label>
            </div>

            <div class="form-checkbox">
              <input type="checkbox" class="checkbox-position" id="botanist" value="3" v-model="user.userRoles" />
