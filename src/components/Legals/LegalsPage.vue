  ...
  <div class="main-container">
    ...
    <div class="legals-text">
      ...
      <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est
        précisé aux utilisateurs du site internet https://www.arosaje.fr/ l'identité des différents intervenants dans le
        cadre de sa réalisation et de son suivi:</p>
      <p>Propriétaire du site : Les 4 bota’clic - Contact : arosaje@epsi.fr Les 4 bota'clic - Adresse : 10 rue fernand
        robert, 35000 Rennes.</p>
      <p>Identification de l'entreprise : Les 4 bota’clic au capital social de 0€ - SIREN : - RCS ou RM : - Adresse
        postale : 10 rue fernand robert, 35000 Rennes</p>
      ...
      <p>Les 4 bota’clic est propriétaire des droits de propriété intellectuelle et détient les droits d’usage sur tous
        les éléments accessibles sur le site internet, notamment les textes, images, graphismes, logos, vidéos,
        architecture, icônes et sons.</p>
      <p>Toute reproduction, représentation, modification, publication, adaptation de tout ou partie des éléments du site,
        quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable des 4 Bota’clic.
      </p>
      ...
      <p>Les 4 bota’clic ne pourront être tenu pour responsable des dommages directs et indirects causés au matériel de
        l’utilisateur, lors de l’accès au site https://www.arosaje.fr/.</p>
      <p>Les 4 bota’clic déclinent toute responsabilité quant à l’utilisation qui pourrait être faite des informations et
        contenus présents sur https://www.arrosage.fr/.
        Les 4 bota’clic s’engagent à sécuriser au mieux le site https://www.arosaje.fr/, cependant sa responsabilité ne
        pourra être mise en cause si des données indésirables sont importées et installées sur son site à son insu.</p>
      <p>Des espaces interactifs (espace contact ou commentaires) sont à la disposition des utilisateurs. Les 4 bota’clic
        se réservent le droit de supprimer, sans mise en demeure préalable, tout contenu déposé dans cet espace qui
      ...
      <p>Conformément aux dispositions de la loi 78-17 du 6 janvier 1978 modifiée, l’utilisateur du site
        https://www.arosaje.fr/ dispose d’un droit d’accès, de modification et de suppression des informations collectées.
        Pour exercer ce droit, envoyez un message à notre Délégué à la Protection des Données : Thomas Le Corvec -
        ThomasLeCorvec@Epsi.fr.</p>
      ...
      <p>Le site https://www.arosaje.fr/ contient des liens hypertextes vers d’autres sites et dégage toute responsabilité
        à propos de ces liens externes ou des liens créés par d’autres sites vers https://www.arosaje.fr/.</p>
      <p>La navigation sur le site https://www.arosaje.fr/ est susceptible de provoquer l’installation de cookie(s) sur
        ...
        exemple.</p>
      <p>Vous avez la possibilité d’accepter ou de refuser les cookies en modifiant les paramètres de votre navigateur.
